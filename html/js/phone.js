                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Gizli Bir Çağrı Başlattın!");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Zaten bir çağrıdasın!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Aradığın kişi meşgul.!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Böyle bir numara mevcut değil");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Kendini Arayamazsın!");
        }
    });
});
            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Zaten bir çağrıdasın!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Aradığın kişi meşgul.!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Böyle bir numara mevcut değil");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Kendini Arayamazsın!");
        }
    });
});
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
        ...
        QB.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "Kendine mesaj atamazsın..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Edit Contact", "Bütün boşlukları doldur!");
    }
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Add Contact", "Bütün boşlukları doldur!");
    }
});
        ...
        if (cData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Aradğınız kişi şu an başkasıyla konuşuyor.");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Böyle bir numara mevcut değil.");
            }
