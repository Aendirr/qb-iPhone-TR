        ...
        switch(event.data.action) {
            ...
            case "UpdateCallTime":
                ...
                if (!QB.Phone.Data.IsOpen) {
                    ...
                    $(".call-notifications-title").html("Çağrı Süresi ("+timeString+")");
                    $(".call-notifications-content").html("Aranan Numara "+event.data.Name);
                ...
                $(".phone-currentcall-title").html("Çağrı Süresi: ("+timeString+")");
                break;
