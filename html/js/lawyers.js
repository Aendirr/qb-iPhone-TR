            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Zaten bir aramaya bağlısınız!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Bu kişi zaten bir çağrıda");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Bu kişi mevcut değil!");
            }
        } else {
